...
export default function BranchAdminSidebar() {
  ...
  const menuItems = [
    { href: '/branch-dashboard', icon: <LayoutDashboard size={20} />, label: 'Dashboard' },
    { href: '/branch-dashboard/classes', icon: <BookOpen size={20} />, label: 'Classes' },
  ...
  return (
    <div className="fixed top-0 left-0 w-64 h-screen bg-[#0f172a] text-white flex flex-col">
      <div className="p-6">
        ...
        <p className="text-sm text-gray-400">Branch Admin Portal</p>
      </div>
